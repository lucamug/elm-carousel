...
var _lucamug$elm_carousel$Main$view = function (model) {
	...
	return A2(
		...
		},
		{
			...
			_1: {
				ctor: '::',
				_0: _elm_lang$core$Native_Utils.eq(currenthash, '#carousel') ? A2(
					_elm_lang$html$Html$div,
					{ctor: '[]'},
					{
						ctor: '::',
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text('Carousel'),
								_1: {ctor: '[]'}
							}),
						_1: {
							ctor: '::',
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$class('carousel'),
									_1: {ctor: '[]'}
								},
								{
									ctor: '::',
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html_Attributes$class('carousel-cell'),
											_1: {ctor: '[]'}
										},
										{ctor: '[]'}),
									_1: {
					...
					}) : (_elm_lang$core$Native_Utils.eq(currenthash, '#top') ? A2(
					_elm_lang$html$Html$h1,
					{ctor: '[]'},
					{
						ctor: '::',
						...
						_1: {ctor: '[]'}
					}) : (_elm_lang$core$Native_Utils.eq(currenthash, '#post') ? A2(
					_elm_lang$html$Html$h1,
					{ctor: '[]'},
					{
						ctor: '::',
						...
						_1: {ctor: '[]'}
					}) : (_elm_lang$core$Native_Utils.eq(currenthash, '#comment') ? A2(
					_elm_lang$html$Html$h1,
					{ctor: '[]'},
					{
						ctor: '::',
